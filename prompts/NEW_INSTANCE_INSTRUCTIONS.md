...
If you're a lead engineer, not PM/Architect:

1. Read sprint spec you're implementing (not HANDOFF.md first)
2. Read HANDOFF.md to know what dependencies are ready
3. Implement sprint per spec
4. Fill "Implementation Summary" in sprint spec when done
5. Fill "Handoff to Next Sprint" with context for future work
6. Update sprint status in spec to COMPLETE
7. Notify user to run PM review

**Do NOT update HANDOFF.md directly** - PM/Architect role does that.
...
1. Sprint spec for current work
2. HANDOFF.md (to check dependencies)
3. MCP_ARCHITECTURE_GUIDE.md (patterns to follow)
4. Existing code in src/plorp/
